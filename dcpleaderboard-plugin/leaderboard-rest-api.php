...
function register_routes() {
    register_rest_route( 'dcpleaderboard/v1', '/clubs', array(
      'methods' => 'GET', // or POST, PUT, DELETE, etc.
      'callback' => 'clubs_leaderboard_endpoint_callback',
    ));

    register_rest_route( 'dcpleaderboard/v1', '/divisions', array(
      'methods' => 'GET', // or POST, PUT, DELETE, etc.
      'callback' => 'divisions_endpoint_callback',
    ));

    register_rest_route( 'dcpleaderboard/v1', '/areas', array(
      'methods' => 'GET', // or POST, PUT, DELETE, etc.
